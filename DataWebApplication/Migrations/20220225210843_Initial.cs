...
namespace DataWebApplication.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LanguagePerson_People_PersonsPersonId",
            ...
            migrationBuilder.InsertData(
                table: "People",
                columns: new[] { "PersonId", "CityId", "CountryId", "Name", "Phone" },
                values: new object[,]
                {
                    { 1, 1, 1, "Martin", "0743123456" },
                    { 3, 2, 1, "Sven", "0743124125" },
                    { 2, 3, 2, "Elon", "0777622344" },
                    { 5, 4, 3, "Björn", "0777622344" },
                    { 4, 5, 4, "Hans", "0764312345" }
                });

            migrationBuilder.InsertData(
                table: "PersonLanguages",
                columns: new[] { "LanguageId", "PersonId", "Id" },
                values: new object[,]
                {
                    { 1, 1, 0 },
                    { 2, 1, 0 },
